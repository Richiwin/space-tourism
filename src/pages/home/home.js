  ...
  return (
    <div
      ...
      <div className="md:flex-col md:h-full sm:h-full md:max-w-max md:mt-16 md:text-center md:mx-auto md:w-[80%] sm:w-full sm:px-4 flex flex-row justify-between mt-auto items-end pb-[8rem] md:pb-[2rem] px-[120px] ">
        <div className="space-y-4 w-1/2 md:w-full">
          <h4 className="uppercase text-primary-100 whitespace-nowrap md:text-base sm:!text-xs">
            So, you want to travel to
          </h4>
          <h1 className="uppercase text-white md:text-[120px] sm:!text-6xl ">
            Space
          </h1>
